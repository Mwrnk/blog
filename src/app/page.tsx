...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="text-sm">
        Hi, im Mateus Werneck, a software engineer based in Brazil. I specialize
        in building web applications and have a passion for creating efficient,
        user-friendly experiences. I&apos;m currently intern at {" Rubeus "}.
      </p>
        ...
        <div className="flex flex-col justify-center gap-4 max-sm:items-center">
          <div className="group -m-8 flex select-all items-center gap-3 p-8 transition-all">
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <a
                href="mailto:mateuswerneckelizeu@gmail.com"
